...
with open("C:\\Users\\abzal\\OneDrive\\Desktop\\SkillRank\\Assessment-2\\ex5.json", "r") as file:
    data = json.load(file)
...
with open("C:\\Users\\abzal\\OneDrive\\Desktop\\SkillRank\\Assessment-2\\ex5.json", "w") as file:
